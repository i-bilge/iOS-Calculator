  ...
  //if there is input:...
    ...
    //when user click on operations
      ...
      if (operation != "") {
        ...
        operation = "";
        secondNumber = Number(calculation.textContent);
        firstNumber = secondNumber;

        console.log(
          "Click nonFirst operation=> Num1: ",
          firstNumber,
          "Num2: ",
          secondNumber,
          "OP: ",
    ...
    //when user click on additional operators
      ...
      console.log(
        "After additionalOperations=> Num1: ",
        firstNumber,
        "Num2: ",
        secondNumber,
        "OP: ",
